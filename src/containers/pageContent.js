const pageContent = {
    ID: {
      ...
      saveconfirm:"Yakin akan simpan data ini ?",
      savesuccess: "berhasil di simpan !",
      savefailed: "gagal di simpan !",
      deleteconfirm:"Yakin akan menghapus data ini ?",
      ...
      nodifferent: "tidak ada yang berubah, ",
      history: "History",
      print: "Cetak",
      updateBy: "User Ubah",
      updateDate: "Tgl. Ubah",
    ...
    EN: {
      ...
      saveconfirm: "Are you sure you want to save this data ?",
